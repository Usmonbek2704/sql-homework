...
where p.Amount is null and p.OrderID is null
...
from Employees e
left join Departments d  on d.DepartmentID=e.DepartmentID
where d.DepartmentName is not null  and e.Name is not null 
...
from Employees e1
left join Employees e2 on e1.ManagerID<e2.EmployeeID and e1.DepartmentID<>e2.DepartmentID
...
select o.OrderID, year(o.OrderDate), c.FirstName, c.LastName
from Orders o
...
select e1.Name, e2.Name, e1.ManagerID, e2.Salary
from Employees e1
left join Employees e2 on e2.ManagerID=e1.EmployeeID
where e2.Salary>60000 
group by e1.Name, e2.Name, e1.ManagerID, e2.Salary
